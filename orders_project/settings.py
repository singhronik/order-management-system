"""
Django settings for orders_project.
"""
...
# Database
# Using SQLite for local development. Swap for Postgres in production
# by setting DATABASE_URL and using dj-database-url / psycopg2.
DATABASES = {
    'default': {
